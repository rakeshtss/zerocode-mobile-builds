  ...
  if (by_category === "by-channel") {
    ...
    $.each(channelsRes, function (ei, eo) {
      ...
      $.each(periodRes, function (pi, po) {
        ...
        var _td = $('<td/>', { 'date-attr': _data_year + '-' + _data_month + '-1', id: 'usvtar' + eo.channelName.replace(/\s/g, '') + po.periodName.replace(/\s/g, '') });
        _tr.append(_td);
        // tar
      ...
      $.each(periodRes, function (pi, po) {
        ...
        var _td = $('<td/>', { 'date-attr': _data_year + '-' + _data_month + '-1', id: 'rsvtar' + eo.channelName.replace(/\s/g, '') + po.periodName.replace(/\s/g, '') });
        _tr2.append(_td);
        // achive
      ...
      $.each(periodRes, function (pi, po) {
        ...
        var _td = $('<td/>', {'date-attr': _data_year + '-' + _data_month + '-1', id: 'tsvtar' + eo.channelName.replace(/\s/g, '') + po.periodName.replace(/\s/g, '') });
        _tr3.append(_td);
        // balance
    ...
    $.each(execRes, function (ei, eo) {
      if (eo.excutiveName !== null) {
        ...
        $.each(periodRes, function (pi, po) {
          ...
          var _td = $('<td/>', { 'date-attr': _data_year + '-' + _data_month + '-1', id: 'usvtar' + eo.excutiveName.replace(/\s/g, '') + po.periodName.replace(/\s/g, '') });
          _tr.append(_td);
          // tar
        ...
        $.each(periodRes, function (pi, po) {
          ...
          var _td = $('<td/>', { 'date-attr': _data_year + '-' + _data_month + '-1', id: 'rsvtar' + eo.excutiveName.replace(/\s/g, '') + po.periodName.replace(/\s/g, '') });
          _tr2.append(_td);
          // achive
          _td = $('<td/>');
        ...
        $.each(periodRes, function (pi, po) {
          ...
          var _td = $('<td/>', { 'date-attr': _data_year + '-' + _data_month + '-1', id: 'tsvtar' + eo.excutiveName.replace(/\s/g, '') + po.periodName.replace(/\s/g, '') });
          _tr3.append(_td);
          // balance
