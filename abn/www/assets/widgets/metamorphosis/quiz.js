if (window.jQuery) {
  ...
  $(document).ready(function () {
    ...
    function getQuizList() {
      ...
      $.ajax({
        url: url + 'metamorphosis/api/quiz_question/list/student-quiz-questions-list',
        type: 'POST',
        dataType: 'json',
        headers: header,
    ...
    function onStartQuiz() {
      $.ajax({
        url: url + 'metamorphosis/api/student_quiz/save-update/student-quiz-save',
        type: 'POST',
        dataType: 'json',
        headers: header,
        data: JSON.stringify({
    ...
    function submitQuizAnswer() {
      ...
      $.ajax({
        url: url + 'metamorphosis/api/student_quiz/save-update/student-quiz-response-save',
        type: 'POST',
        dataType: 'json',
        headers: header,
    ...
    function onTestStart() {
      ...
      $('#start_quiz').hide();
      $.ajax({
        url: url + 'metamorphosis/api/student_quiz/select/student-quiz-details',
        type: 'POST',
        dataType: 'json',
        headers: header,
        data: JSON.stringify(payload),
